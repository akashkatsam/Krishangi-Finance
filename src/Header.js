...
import kyc1 from './krishangi logo1.jpg'
import kyc2 from './kyc2.png'
import kyc3 from './nse.png'
...
<Navbar ref={navRef} className={`navbar navbar-expand-lg fixed-top transition-all duration-300 ${
  ...
  <div className={`custom-menu ${isMenuOpen ? "open" : ""}`}>
    ...
    <NavLink to="/investment-inside" className={({ isActive }) => isActive ? "custom-nav-link active" : "custom-nav-link"}>Investment Insights</NavLink>
